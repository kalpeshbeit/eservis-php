    ...
    <table align="left">
     ...
     <table class="table" align="left" repeat_header="1" style="margin-top: 10px;">
         ...
         <tbody>     
            ...
            <?php   
             ...
             <tr>
                <td colspan="5" align="right" bgcolor="white"><b>UKUPNO:</b></td>
                <?php if($sume->sumaPopust > 0){ ?>
                <td align="right" bgcolor="silver"><?php echo $sume->sumaPopust ?></td>
                <?php } ?>
                ...
                <td align="right" bgcolor="silver"><?php echo number_format($zaglavlje->do_iznos + $zaglavlje->do_iznosPDV,  2, ',', '.');?></td>
     ...
     <table class="table2" align="right">
        ...
        <tbody>
         <?php if (!empty($rekapitualcijaporeza)) {  ?>                          
            <?php $rank = 0; foreach ($rekapitualcijaporeza as $porez) { ?>

            <tr style="border: none;">
            
                <td colspan="2"></td>
                <td ><?php echo $porez->pzs_naziv; ?></td>
                <td ><?php echo $porez->porez_pz_posto; ?></td>
                <td ><?php echo number_format($porez->sumaIznosa, 2, ',', '.') ?></td>
                <td ><?php echo number_format($porez->sumaPorez, 2, ',', '.') ?></td>
                        
            </tr> 
            <?php } }?>
            
            <tr>
                <td colspan="4"> Ukupno porez: </td>
                <td colspan="2"><?php echo number_format((float)$zaglavlje->do_iznosPDV, 2, ',', '.' )  ?></td>
            </tr>
            
            
            
              <tr>
                <td style="font-weight: bold;" colspan="4">UKUPNO ZA PLATITI:</td>
               
                <td style="font-weight: bold;" colspan="2"><?php echo number_format($zaglavlje->do_iznos + $zaglavlje->do_iznosPDV,  2, ',', '.'); ?> Kn</td>
    ...
    <div style="position: absolute; bottom:70px;  left: 15%; right: 15%; text-align: center; font-size: 11px">
        <p style="font-size: 11px">Ra&#269;un je ispisan na ra&#269;unalu i va&#382;i bez &#382;iga i potpisa</p> 
    </div>
