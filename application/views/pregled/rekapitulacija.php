...
$('#pregledStanjeForm').submit(function(evnt){
    ...
    nuID = $("#naplatni_uredjaj").val();
     ...
     if(pmID != "" && nuID != "" && vpID != "")
     {
        $('#report').attr('src', "<?php echo site_url(); ?>pregled/rekapituliraj/"+datOD+'/'+datDO+'/'+pmID+'/'+nuID+'/'+vpID);
        $('#pdf').show();    
        $('#pregled').hide();     
     }
     else if(pmID != "" && nuID != "" && vpID == "")
     {
           $('#report').attr('src', "<?php echo site_url(); ?>pregled/rekapituliraj/"+datOD+'/'+datDO+'/'+pmID+'/'+nuID);
           $('#pdf').show();    
           $('#pregled').hide(); 
     }  
  ...
  <div class="row">
    <div id="breadcrumb" class="col-xs-12">
        <ol class="breadcrumb">
            ...
            <li><a href="#">Rekapitulacija poreza</a></li>
        </ol>
    </div>
</div>
...
<div class="well">
    ...
    <h4 class="page-header">Rekapitulacija poreza</h4><br/>     
